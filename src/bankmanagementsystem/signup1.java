...
signup1(){
   ...
   female.setBackground(Color.white);
    ...
    other.setBounds(630,300,120,30);
    add(other);
    ...
    email.setBounds(100,350,400,30);
    add(email);
  emailTextField = new JTextField();
   ...
   emailTextField.setBounds(300,350,400,30);
    ...
    marital.setBounds(100,400,400,30);
    add(marital);
   ...
   unmarried.setBackground(Color.white);
    ...
    add(unmarried);
     Other = new JRadioButton("Other");
    Other.setBackground(Color.white);
    Other.setBounds(630,400,120,30);
    add(Other);
    ...
    address.setBounds(100,450,400,30);
    add(address);
   ...
   addressTextField.setBounds(300,450,400,30);
    ...
    state.setBounds(100,500,400,30);
    add(state);
   ...
   cityTextField.setBounds(300,550,400,30);
    ...
    pincode.setBounds(100,600,400,30);
    add(pincode);
...
public void actionPerformed(ActionEvent ae){
   ...
   try{
       ...
       JOptionPane.showMessageDialog(null,"Name is Required");
           ...
           Conn c = new Conn();
           String query= "insert into signup1 values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+state+"','"+pincode+"')";
